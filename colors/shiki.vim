...
let s:color_def["Type"]             = [83, -1, 'Bold']
...
let s:color_def["IncSearch"]        = [235, 188, 'Bold']
let s:color_def["MatchParen"]       = [196, 'NONE', 'Bold']
let s:color_def["Search"]           = [235, 185, 'Bold']
...
let s:color_def["SpecialKey"]       = [126, -1, '']
let s:color_def["SpellBad"]         = [250, 124, '']
